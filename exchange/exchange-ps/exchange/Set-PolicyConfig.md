...
The InformationBarrierMode parameter specifies the mode that controls total number of segments and how many segments can a user be part of. The supported values are:
